# -*- coding: utf-8 -*-
#
# 8iUnrealPlugin documentation build configuration file, created by
# sphinx-quickstart on Tue Sep 20 10:33:33 2016.
#
...
#
# html_title = u'8iUnrealPlugin v0.4.0'
...
htmlhelp_basename = '8iUnrealPlugindoc'
...
latex_documents = [
    (master_doc, '8iUnrealPlugin.tex', u'8iUnrealPlugin Documentation',
     u'8i', 'manual'),
]
...
man_pages = [
    (master_doc, '8iUnrealplugin', u'8iUnrealPlugin Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, '8iUnrealPlugin', u'8iUnrealPlugin Documentation',
     author, '8iUnrealPlugin', 'One line description of project.',
     'Miscellaneous'),
]
